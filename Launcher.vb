...
Public Class Launcher
    ...
    Dim adsDisabled As Boolean = True

    Dim Version As String = "5.51.0.5806"
    Dim Version_2 As String = "1.37.0.2298"
    ...
    Private Sub LoginBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LoginBtn.Click
        Try
            If launcherEdition = 2 And Environment.Is64BitOperatingSystem = False Then
                MessageBox.Show("YGOPRO 2 is not compatible with your operating system, please install YGOPRO from ygopro.org")
                Return
            End If
...
#Region "Buttons"
    ...
    Private Sub DeckConstructionBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DeckConstructionBtn.Click
        Dim objwriter As New System.IO.StreamWriter(Current & "\YGOPRO\" & "duel.CONF")
        ...
        Try
            If sParts(0) = "LoginVerified" Then
                Try
                    ...
                    Catch
                    End Try
                    If My.Settings.showAdvertisements = True And adsDisabled = False Then
